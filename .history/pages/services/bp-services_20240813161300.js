    ...
    <div>
      ...
      <div className=" bg-slate-100  p-[5em]">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mt-[2em]">
            <p className="text-[17px] text-justify mt-3">
             <b>NOTE : </b> Changes to This Policy We may update this Privacy Policy from time
            ...
            <p className="text-[17px] text-justify mt-3">
             ...
             <a
              ...
              <b>Address :</b> <address>BPAAS Solutions Private Limited, Unit number 601 & 602,
              Vipul Square, Sushant Lok Phase 1, Gurugram, Haryana 1220092</address> 
            </p>
          </div>
        </div>
      </div>
