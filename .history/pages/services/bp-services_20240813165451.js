    ...
    <div>
      ...
      <div className=" bg-slate-100  p-[5em]">
        <div className="container mx-auto max-w-6xl">
          ...
          <div 
           className={`${
                    showAnswer ? "p-2 mt-4 bg-[#fb923c] max-w[1200px]" 
                    : "p-2 mt-4 border-gray-900 border-b-2 max-w[1200px]"
                  }`}
          >
            <div className="flex gap-10 items-center justify-between">
              <h3 className="text-[20px] font-sans font-semibold" onClick={() => setShowAnswer(!showAnswer)}>
                header
              </h3>
                <div
