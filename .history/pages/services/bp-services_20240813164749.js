    ...
    <div>
      ...
      <div className=" bg-slate-100  p-[5em]">
        <div className="container mx-auto max-w-6xl">
          ...
          <div 
        //   className="p-2 mt-4 border-2 border-blue-800 max-w[1200px]"
           className={`${
                    showAnswer ? "p-2 mt-4 border-2 border-blue-800 border-b-2 max-w[1200px]" 
                    : "p-2 mt-4 border-2 border-blue-800 max-w[1200px]"
                  }`}
          >
