    ...
    <div>
      <div className="relative">
        <TopBanner2
          ...
          btnShow={false}
        />
        <div className="absolute top-[1em] right-[10em] hidden sm:block md:hidden lg:block xl:block">
          <Image
            src="/images/privacypolicy2.png"
            className="w-[20px] sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mx-auto"
            width="500"
            height="500"
      ...
      <div className=" bg-slate-100  p-[1em] sm:p-[5em] md:p-[5em] lg:p-[5em] xl:p-[5em]">
        <div className="container mx-auto max-w-full sm:max-w-6xl md:max-w-6xl lg:max-w-6xl xl:max-w-6xl">
