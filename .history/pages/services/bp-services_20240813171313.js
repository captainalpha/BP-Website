...
function BpServices() {
  ...
  const privacyStatement = [
    {
      ...
      content: (
        <>
          <p
            className={`text-[18px] bg-gray-300 mt-2 p-3 rounded-md
          ...
          >
            ...
            <p className="text-[17px] text-justify mt-3">
              ...
              interaction with our Site, including IP address, browser type,
      ...
      <div className=" bg-slate-100  p-[5em]">
        <div className="container mx-auto max-w-6xl">
          ...
          {/* {privacyStatement?.map((item,ind)=>(
            ...
            className={`${
              showAnswer
                ? "p-2 mt-8 bg-[#fb923c] max-w[1200px]"
                : "p-2 mt-8 border-[#fb923c] border-2 max-w[1200px]"
            }`}
          >
            <div className="flex gap-10 items-center justify-between">
              <h3
                className="text-[20px] font-sans font-semibold cursor-pointer"
              ...
              >
                {showAnswer ? <AiOutlineMinus /> : <FiPlus />}
              </div>
            </div>
          </div>
          <div
  ...
  <div key={ind} className="max-w-[1200px] mx-auto mb-4">
    <div
      className={`p-4 mt-8 rounded-lg shadow-md transition-colors duration-500 ease-out cursor-pointer ${
        showAnswer ? "bg-[#fb923c] text-white" : "bg-white border-[#fb923c] border-2"
      }`}
      onClick={() => setShowAnswer(!showAnswer)}
    >
    ...
    <div
      className={`overflow-hidden transition-all duration-500 ease-out ${
        showAnswer ? "max-h-[1000px] opacity-100 mt-3" : "max-h-0 opacity-0"
      }`}
    >
      <div className="p-4 border-t-2 border-[#fb923c] bg-white">
        {item?.content}
      </div>
    </div>
  </div>
