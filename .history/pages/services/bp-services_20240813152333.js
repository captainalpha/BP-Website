        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mt-5">
            ...
            <p className="text-[17px] text-justify">
              Effective Date: 12th Aug 2024 <br/><br/> BPAAS Solutions Pvt. Ltd. (&ldquo;we,&rdquo;
                &ldquo;our,&rdquo; &ldquo;us&rdquo;) is committed to protecting your privacy. This Privacy
          ...
          <div className="mt-[3em]">
            <h1 className="text-[20px] font-bold text-zinc-800">Information We Collect</h1>
            <p>
            &ldquo;Personal data&rdquo; is defined to include information that whether on its own or in combination with other information may be used to readily identify or contact you such as: name, address, email address, phone number etc.
            </p>
          </div>
        </div>
      </div>
