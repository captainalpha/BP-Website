    ...
    <div>
      ...
      <div className=" bg-slate-100  p-[5em]">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mx-[7em] p-2 rounded-md mt-4 bg-lime-200 hover:bg-green-300 max-w[1200px]">
            <div className="flex gap-10 items-center justify-between">
              ...
              >
                <span className="flex">
                  <MdChecklistRtl className="mt-[5px] text-[22px] text-blue-900 me-1" />
                  {index + 1}
                  {". "}
                  header
                </span>
              ...
              <div>
                <div
                  onClick={() => setShowAnswer(!showAnswer)}
                  className={`${
                    showAnswer ? "rotate-180 bg-gray-300" : ""
        ...
        shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] hover:bg-pink-400 hover:text-white`}
              >
                dfvdf
              </p>
            </div>
